...
export default function AvatarCard({ avatar,description, name, age, hobbies, location }) {
  return (
    <div className="flex-col justify-center items-center border  rounded-md  border-red-500 w-80">
      ...
      <img className="rounded-full border-2 border-red-600 w-20 hover:scale-110 hover:cursor-pointer" src={avatar} alt="" />
      <h2 className=" text-lg font-semibold py-1">{name}</h2>
        <h3 className=" text-lg font-semibold ">{age}</h3>
      </div>
      <div className=" pt-4 ">
       <p className=" py-4 px-4 font-medium from-neutral-300 bg-white " >{description}</p>
      </div>
